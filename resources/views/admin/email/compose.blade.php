                                ...
                                <div class="aside-content">
                                    ...
                                    <div class="email-aside-nav collapse">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link d-flex align-items-center" href="{{ url('admin/email/compose') }}">
                                            ...
                                            <li class="nav-item active">
                                                <a class="nav-link d-flex align-items-center" href="{{url('admin/email/sent_email')}}">
                                        ...
                                        <div class="to">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    name="user_id">
                                                        <option value="AL">Seleccione un email</option>
                                                        @foreach ($getEmail as $value )
                                                            <option value="{{$value->id}}">
                                                            {{$value->email}}- {{$value->role}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="px-3">
                                        ...
                                        <div>
                                            <div class="col-md-12">
                                                ...
                                                <button class="btn btn-secondary me-1 mb-1" type="button"> Cancelar</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
